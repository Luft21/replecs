    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
        ...
        <div 
            x-data="{
                ...
                members: [
                    { name: 'Jose Febrian Limbor', image: '<?php echo e(asset('images/vergil.jpg')); ?>' },
                    { name: 'Ahmad Mukhlash Muhtady', image: '<?php echo e(asset('images/dante.jpg')); ?>' },
                    { name: 'Virginia Angel Alexandra Soen', image: '<?php echo e(asset('images/lady.jpg')); ?>' }
                ],
                prev() {
                    this.direction = 'left';
...
<?php /**PATH C:\Users\Klein\Workspace\replecs\resources\views/livewire/about-page.blade.php ENDPATH**/ ?>