...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $laptops = [
            // --- 2023 ---
            ['ASUS ROG Strix SCAR 17 (2023)', [4, 4, 4, 5, 4, 4], '1.png'],
            ['Razer Blade 16 (2023)', [4, 4, 3, 5, 4, 5], '2.png'],
            ['Lenovo Legion Pro 7i/7 (Gen 8, 2023)', [4, 4, 4, 4, 4, 4], '3.png'],
            ['MSI Titan GT77 HX (13V, 2023)', [4, 4, 5, 5, 4, 5], '4.png'],
            ['Alienware m18 (R1, 2023)', [4, 4, 5, 4, 3, 4], '5.png'],
            ['ASUS ROG Zephyrus G14 (GA402, 2023)', [3, 4, 2, 5, 3, 2], '6.png'],
            ['Acer Predator Helios 16/18 (PH16/PH18, 2023)', [4, 4, 4, 4, 3, 3], '7.png'],
            ['HP Omen 16 (2023)', [3, 3, 4, 4, 3, 3], '8.png'],
            ['Dell G16 7630, 2023)', [2, 3, 4, 3, 2, 1], '9.png'],
            ['Gigabyte AORUS 15 2023', [4, 4, 4, 4, 4, 3], '10.png'],
            ['Lenovo LOQ 15 (2023)', [2, 3, 3, 3, 2, 1], '11.png'],
            ['MSI Cyborg (2023)', [2, 3, 3, 3, 2, 1], '12.png'],

            // --- 2024 ---
            ['ASUS ROG Strix SCAR 18 (G834, 2024)', [5, 5, 5, 5, 4, 4], '13.png'],
            ['Razer Blade 14 (2024)', [3, 4, 2, 4, 3, 3], '14.png'],
            ['Alienware m16 R2 (2024)', [4, 4, 4, 4, 4, 2], '15.png'],
            ['Lenovo Legion Pro 5i (Gen 9, 2024)', [4, 4, 4, 4, 4, 3], '16.png'],
            ['ASUS ROG Zephyrus G16 (GU605, 2024)', [4, 4, 2, 5, 3, 3], '17.png'],
            ['HP Omen Transcend 14 (2024)', [3, 4, 1, 5, 3, 2], '18.png'],
            ['Acer Predator Helios 16/18 (PHN16/PHN18, 2024)', [4, 4, 4, 4, 3, 2], '19.png'],
            ['MSI Raider GE78 HX (14V, 2024)', [5, 5, 4, 5, 4, 4], '20.png'],
            ['Gigabyte AORUS 16X/17X (2024)', [4, 4, 4, 4, 4, 2], '21.png'],
            ['ASUS TUF Gaming F16 (2024)', [3, 4, 3, 3, 4, 2], '22.png'],

            // --- 2025 (Estimasi) ---
            ['MSI Titan 18 HX (AI/2025)', [5, 5, 5, 5, 5, 5], '23.png'],
            ['Razer Blade 16 (2025)', [5, 5, 3, 5, 4, 4], '24.png'],
            ['ASUS ROG Strix SCAR 16/18 (2025)', [5, 5, 5, 5, 4, 5], '25.png'],
            ['Lenovo Legion Pro 7i (Gen 10, 2025)', [5, 5, 4, 5, 5, 4], '26.png'],
            ['ASUS ROG Zephyrus G14 (2025)', [4, 5, 2, 5, 3, 3], '27.png'],
            ['Alienware m18 R2 2025', [5, 5, 5, 5, 4, 5], '28.png'],
            ['HP Omen 16 Transcend (2025)', [4, 4, 4, 5, 4, 3], '29.png'],
            ['Gigabyte AERO 16 OLED (Gaming Capable Creator)', [4, 4, 2, 5, 4, 3], '30.png'],
        ];
