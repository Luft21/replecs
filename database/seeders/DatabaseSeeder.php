...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $laptops = [
            // --- 2023 ---
            ['ASUS ROG Strix SCAR 17 (2023)', [4, 4, 2, 5, 4, 2], 'alternatif-images/1.png'],
            ['Razer Blade 16 (2023)', [4, 4, 3, 5, 4, 1], 'alternatif-images/2.png'],
            ['Lenovo Legion Pro 7i/7 (Gen 8, 2023)', [4, 4, 2, 4, 4, 2], 'alternatif-images/3.png'],
            ['MSI Titan GT77 HX (13V, 2023)', [4, 4, 1, 5, 4, 1], 'alternatif-images/4.png'],
            ['Alienware m18 (R1, 2023)', [4, 4, 1, 4, 3, 2], 'alternatif-images/5.png'],
            ['ASUS ROG Zephyrus G14 (GA402, 2023)', [3, 4, 4, 5, 3, 4], 'alternatif-images/6.png'],
            ['Acer Predator Helios 16/18 (PH16/PH18, 2023)', [4, 4, 2, 4, 3, 3], 'alternatif-images/7.png'],
            ['HP Omen 16 (2023)', [3, 3, 2, 4, 3, 3], 'alternatif-images/8.png'],
            ['Dell G16 7630, 2023)', [2, 3, 2, 3, 2, 5], 'alternatif-images/9.png'],
            ['Gigabyte AORUS 15 2023', [4, 4, 2, 4, 4, 3], 'alternatif-images/10.png'],
            ['Lenovo LOQ 15 (2023)', [2, 3, 3, 3, 2, 5], 'alternatif-images/11.png'],
            ['MSI Cyborg (2023)', [2, 3, 3, 3, 2, 5], 'alternatif-images/12.png'],

            // --- 2024 ---
            ['ASUS ROG Strix SCAR 18 (G834, 2024)', [5, 5, 1, 5, 4, 2], 'alternatif-images/13.png'],
            ['Razer Blade 14 (2024)', [3, 4, 4, 4, 3, 3], 'alternatif-images/14.png'],
            ['Alienware m16 R2 (2024)', [4, 4, 2, 4, 4, 4], 'alternatif-images/15.png'],
            ['Lenovo Legion Pro 5i (Gen 9, 2024)', [4, 4, 2, 4, 4, 3], 'alternatif-images/16.png'],
            ['ASUS ROG Zephyrus G16 (GU605, 2024)', [4, 4, 4, 5, 3, 3], 'alternatif-images/17.png'],
            ['HP Omen Transcend 14 (2024)', [3, 4, 5, 5, 3, 4], 'alternatif-images/18.png'],
            ['Acer Predator Helios 16/18 (PHN16/PHN18, 2024)', [4, 4, 2, 4, 3, 4], 'alternatif-images/19.png'],
            ['MSI Raider GE78 HX (14V, 2024)', [5, 5, 2, 5, 4, 2], 'alternatif-images/20.png'],
            ['Gigabyte AORUS 16X/17X (2024)', [4, 4, 2, 4, 4, 4], 'alternatif-images/21.png'],
            ['ASUS TUF Gaming F16 (2024)', [3, 4, 3, 3, 4, 4], 'alternatif-images/22.png'],

            // --- 2025 (Estimasi) ---
            ['MSI Titan 18 HX (AI/2025)', [5, 5, 1, 5, 5, 1], 'alternatif-images/23.png'],
            ['Razer Blade 16 (2025)', [5, 5, 3, 5, 4, 2], 'alternatif-images/24.png'],
            ['ASUS ROG Strix SCAR 16/18 (2025)', [5, 5, 1, 5, 4, 1], 'alternatif-images/25.png'],
            ['Lenovo Legion Pro 7i (Gen 10, 2025)', [5, 5, 2, 5, 5, 2], 'alternatif-images/26.png'],
            ['ASUS ROG Zephyrus G14 (2025)', [4, 5, 4, 5, 3, 3], 'alternatif-images/27.png'],
            ['Alienware m18 R2 2025', [5, 5, 1, 5, 4, 1], 'alternatif-images/28.png'],
            ['HP Omen 16 Transcend (2025)', [4, 4, 2, 5, 4, 3], 'alternatif-images/29.png'],
            ['Gigabyte AERO 16 OLED (Gaming Capable Creator)', [4, 4, 4, 5, 4, 3], 'alternatif-images/30.png'],
        ];
